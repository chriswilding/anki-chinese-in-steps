...
INSERT INTO col VALUES(1,1578110400,1578171069407,1578171069405,11,0,0,0,
    ...
    '{"1578170379751": {"sortf": 0, "did": 1578170359311, "latexPre": "\\documentclass[12pt]{article}\n\\special{papersize=3in,5in}\n\\usepackage[utf8]{inputenc}\n\\usepackage{amssymb,amsmath}\n\\pagestyle{empty}\n\\setlength{\\parindent}{0in}\n\\begin{document}\n", "latexPost": "\\end{document}", "mod": 1578171024, "usn": -1, "vers": [], "type": 0, "css": ".card {\n  background-color: white;\n  color: #444;\n  font: 18px/1.5 -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\";\n  text-align: left;\n}\n\n.chinese {\n  font-size: 48px;\n}\n\n.part-of-speech {\n  font-size: 12px;\n}\n\n.sentence {\n  font-size: 24px;\n}\n", "name": "Chinese in Steps", "flds": [{"name": "index", "ord": 0, "sticky": false, "rtl": false, "font": "Arial", "size": 20, "media": []}, {"name": "audio", "ord": 1, "sticky": false, "rtl": false, "font": "Arial", "size": 20, "media": []}, {"name": "chinese", "ord": 2, "sticky": false, "rtl": false, "font": "Arial", "size": 20, "media": []}, {"name": "pinyin", "ord": 3, "sticky": false, "rtl": false, "font": "Arial", "size": 20, "media": []}, {"name": "meaning", "ord": 4, "sticky": false, "rtl": false, "font": "Arial", "size": 20, "media": []}, {"name": "part-of-speech", "ord": 5, "sticky": false, "rtl": false, "font": "Arial", "size": 20, "media": []}, {"name": "sentence", "ord": 6, "sticky": false, "rtl": false, "font": "Arial", "size": 20, "media": []}, {"name": "sentence-pinyin", "ord": 7, "sticky": false, "rtl": false, "font": "Arial", "size": 20, "media": []}, {"name": "sentence-meaning", "ord": 8, "sticky": false, "rtl": false, "font": "Arial", "size": 20, "media": []}], "tmpls": [{"name": "Card 1", "ord": 0, "qfmt": "<div class=\"chinese\">{{chinese}}</div>\n<div class=\"pinyin\"><br></div>\n<div class=\"meaning\"><br></div>\n<div class=\"part-of-speech\"><br></div>\n<hr>\n<div class=\"sentence\">{{sentence}}</div>", "afmt": "<div class=\"chinese\">{{chinese}}</div>\n<div>{{pinyin}}</div>\n<div>{{meaning}}</div>\n<div class=\"part-of-speech\">{{part-of-speech}}</div>\n<div class=\"audio\">{{audio}}</div>\n<hr>\n<div class=\"sentence\">{{sentence}}</div>\n<div>{{sentence-pinyin}}</div>\n<div>{{sentence-meaning}}</div>", "did": null, "bqfmt": "", "bafmt": ""}], "tags": ["chinese-in-steps-1", "lesson-1"], "id": "1578170379751", "req": [[0, "any", [1, 5]]]}}',
